...
import com.example.msap3.NetworkTasks.NetworkCheckClass;
import com.example.msap3.NetworkTasks.NetworkPING;
import com.example.msap3.Notification.ServiceNotification;
...
public class MyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        SharedPreferences prefs= getSharedPreferences("com.example.msap3.ActiveServiceRunning", MODE_PRIVATE);
    ...
    public void onDestroy() {
        ...
        Intent broadcastIntent = new Intent("com.example.msap3");
